    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php 
            if(($akses['m1m1'] != '1') || ($akses['m1m2'] != '1') || ($akses['m1m3'] != '1') || ($akses['m1m4'] != '1')) :
          ?>
          ...
          <?php 
            ...
            if(($akses['m2m1'] != '1') || ($akses['m2m2'] != '1') || ($akses['m2m3'] != '1')) :
          ?>
          <li class="nav-header">DATA DESA</li>
          <?php 
            if($akses['m2m1'] != 1):
          ?>
<!--           <li class="nav-item">
            <a href="<?=site_url('StrukturOrganisasi')?>" class="nav-link">
          ...
          ?>
          <li class="nav-item">
            <a href="<?=site_url('VisiMisi')?>" class="nav-link">
          ...
          ?>
          <li class="nav-item">
            <a href="<?=site_url('PotensiDesa')?>" class="nav-link">
          ...
          <?php 
            ...
            if(($akses['m3m1'] != '1') || ($akses['m3m2'] != '1') || ($akses['m3m3'] != '1')) :
          ?>
          <li class="nav-header">ADMINISTRASI SURAT</li>
          <?php 
            if($akses['m3m1'] != '1'):
          ?>
          <li class="nav-item">
            <a href="<?=site_url()?>LayananSurat" class="nav-link">
              <i class="nav-icon fa fa-drivers-license-o"></i>
              <p>
                Layanan Surat Desa
              </p>
            </a>
          ...
          <?php 
            ...
            if(($akses['m4m1'] != '1') || ($akses['m4m2'] != '1') || ($akses['m4m3'] != '1')) :
          ?>
          <li class="nav-header">LAYANAN INFORMASI DESA</li>
          <?php 
            if($akses['m4m1']) :
          ?>
          <li class="nav-item">
